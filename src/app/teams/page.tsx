  ...
  return (
    ...
    >
      <div className="flex flex-col items-center bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
        <div className="mx-auto mb-6 w-48 h-48 rounded-full bg-gray-100 overflow-hidden ring-4 ring-[#021954]/20 relative flex items-center justify-center group">
          {member.image ? (
            <>
              <Image
                src={member.image}
              ...
              {member.linkedin && (
                ...
                >
                  {/* LinkedIn SVG */}
                  <svg width="48" height="48" viewBox="0 0 40 40" fill="currentColor" className="text-white">
            ...
            <div className="w-full h-full flex items-center justify-center text-6xl text-[#021954]">
